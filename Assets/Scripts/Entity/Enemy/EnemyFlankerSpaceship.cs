...
/// <summary>
/// Dangerous and smart enemy flanker spaceship...
/// </summary>
public class EnemyFlankerSpaceship : Enemy
{
    [Header("Movement")]
    ...
    {
        float desiredAngle = Mathf.Atan2(direction.y, direction.x) * Mathf.Rad2Deg + -90;
    ...
    private void UpdateShooting(Vector2 currentPos, Vector2 realPredictedPos, Vector2 wrappedPredictedPos)
    {
        ...
        sfxManager.Play2DSound("flanker_shoot");
